...
<body class="body">
  ...
  <main class="main">
    ...
    <section id="services" class="section mb-0">
      ...
      <section id="brand-section" class="d-flex flex-column justify-content-center align-items-center text-center brand-section py-5">
          ...
          <h1 class="text-center brand-section-title mb-4">Shop your favorite brand</h1>
            ...
            <div class="btn-group mt-3 mb-4" role="group" aria-label="Car type selector">
              <a href="#car-brands" class="btn brand-btn active">New Cars</a>
              <a href="#car-brands" class="btn brand-btn">Used Cars</a>
          </div>
      ...
      <!-- Toggle Button -->
        <div class="text-center">
          <a class="btn drop-btn my-4" href="../index.html#brand-section" role="button" aria-expanded="false" aria-controls="collapseExample">
            <span>See less
